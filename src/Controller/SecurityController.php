...
//         }
    ...
    public function register(Request $request, UserPasswordEncoderInterface $passwordEncoder, UserRepository $userRepository, SuperMailer $superMailer)
    {
        ...
        if($request->isMethod('POST')){
            ...
            $em->persist($user);
            $em->flush();
            $this->addFlash('success', 'Votre inscription a bien été enregistrée. Elle est en attente de validation. A son activation, vous recevrez un email d\'information ');
